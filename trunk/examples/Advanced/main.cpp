...
int main()
{
	...
	*/
	...
	if (driver->queryFeature(video::EVDF_RENDER_TO_TARGET))
	{
		...
		depthRt = driver->addRenderTargetTexture(core::dimension2d<u32>(256,256), "DEPTH_RTT", irr::video::ECF_D32);
		test->setMaterialTexture(0, depthRt); // set material of cube to render target
